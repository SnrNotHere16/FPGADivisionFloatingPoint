...
HD_PWD='C:/Users/OAkun/Division/Division.runs/Division_axi_gpio_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_axi_gpio_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division_axi_gpio_2_0.tcl
