...
HD_PWD='C:/Users/OAkun/Division/Division.runs/Division_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division_microblaze_0_0.tcl
