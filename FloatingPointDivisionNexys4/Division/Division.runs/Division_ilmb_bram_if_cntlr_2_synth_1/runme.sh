...
HD_PWD='C:/Users/OAkun/Division/Division.runs/Division_ilmb_bram_if_cntlr_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_ilmb_bram_if_cntlr_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division_ilmb_bram_if_cntlr_2.tcl
