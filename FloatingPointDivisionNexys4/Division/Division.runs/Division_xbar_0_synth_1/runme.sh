...
HD_PWD='C:/Users/OAkun/Division/Division.runs/Division_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division_xbar_0.tcl
