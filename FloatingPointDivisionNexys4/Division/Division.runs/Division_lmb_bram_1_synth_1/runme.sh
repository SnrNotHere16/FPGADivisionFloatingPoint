...
HD_PWD='C:/Users/OAkun/Division/Division.runs/Division_lmb_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_lmb_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division_lmb_bram_1.tcl
