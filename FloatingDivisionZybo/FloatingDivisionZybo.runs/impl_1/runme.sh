...
HD_PWD='C:/Users/OAkun/FloatingDivisionZybo/FloatingDivisionZybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FloatingPointDivision_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FloatingPointDivision_wrapper.tcl -notrace
