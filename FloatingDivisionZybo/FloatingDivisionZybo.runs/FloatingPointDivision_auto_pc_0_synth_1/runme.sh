...
HD_PWD='C:/Users/OAkun/FloatingDivisionZybo/FloatingDivisionZybo.runs/FloatingPointDivision_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FloatingPointDivision_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FloatingPointDivision_auto_pc_0.tcl
