...
HD_PWD='C:/Users/OAkun/FloatingDivisionZybo/FloatingDivisionZybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FloatingPointDivision_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FloatingPointDivision_wrapper.tcl
