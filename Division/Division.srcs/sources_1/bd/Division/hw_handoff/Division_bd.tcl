...
################################################################
# This is a generated script based on design: Division
#
...
proc create_root_design { parentCell } {
  ...
  set block_name DivisionTop
  set block_cell_name DivisionTop_0
  if { [catch {set DivisionTop_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DivisionTop_0 eq "" } {
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins DivisionTop_0/clk] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins floating_point_0/aclk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net floating_point_0_m_axis_result_tdata [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins floating_point_0/m_axis_result_tdata]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins DivisionTop_0/reset] [get_bd_pins clk_wiz_1/reset] [get_bd_pins util_vector_logic_0/Op1]
