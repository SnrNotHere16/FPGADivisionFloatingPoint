...
HD_PWD='C:/Users/OAkun/Division/Division.runs/Division_ilmb_v10_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_ilmb_v10_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division_ilmb_v10_2.tcl
