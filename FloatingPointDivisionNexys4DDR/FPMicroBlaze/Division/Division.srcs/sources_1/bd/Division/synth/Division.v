...
module Division
  ...
  Division_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(clk_1),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_0_locked),
        .reset(reset_1));
  Division_floating_point_0_2 floating_point_0
       (.aclk(clk_1),
  ...
  Division_rst_clk_wiz_0_100M_0 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
...
module microblaze_0_local_memory_imp_OSEI4Y
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  Division_dlmb_bram_if_cntlr_1 dlmb_bram_if_cntlr
  ...
  Division_dlmb_v10_1 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  Division_ilmb_bram_if_cntlr_1 ilmb_bram_if_cntlr
