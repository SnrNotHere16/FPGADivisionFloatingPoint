...
HD_PWD='C:/Users/OAkun/Desktop/FPGADivisionFloatingPoint-b08b4753789be5527befda9a8a6824b56bb4a612/Division/Division.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Division_wrapper.tcl -notrace
