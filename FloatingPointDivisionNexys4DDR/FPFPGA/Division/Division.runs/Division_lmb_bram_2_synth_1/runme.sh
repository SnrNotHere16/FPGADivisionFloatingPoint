...
HD_PWD='C:/Users/OAkun/Division/Division.runs/Division_lmb_bram_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Division_lmb_bram_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Division_lmb_bram_2.tcl
